const serviceShortName = 'Shipping'
...
const host = process.env['SHIPPING_SERVICE_HOST'] || '0.0.0.0'
const port = process.env['SHIPPING_SERVICE_PORT'] || 8005
...
app.get('/ship', async (req, res) => {
  ...
  const span = tracer.startSpan('ship', {
